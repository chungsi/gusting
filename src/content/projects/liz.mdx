---
# Cannot use the "layout:" feature, as that requires the mdx file to be in the pages/ folder
...
heroImage: './../../assets/liz/liz_icon.png'
heroImagePos: top
...
import i_bladeDocCode from '@assets/liz/blade_docs_code.png'
import i_bladeDocOutput from '@assets/liz/blade_docs_output.png'
import i_componentSketches from '@assets/liz/component_sketches.png'
import i_buttonFinal from '@assets/liz/final_liz_button.png'
import i_siteOrgDiagram from '@assets/liz/liz_diagramDrawing_c.jpg'
import i_buttonV1 from '@assets/liz/liz_v1_button.png'
import i_buttonV2 from '@assets/liz/liz_v2_button.png'
import i_overview from '@assets/liz/overview.png'
import i_sassDocCode from '@assets/liz/sass_doc_code.png'
import i_sassDocOutput from '@assets/liz/sass_doc_output.png'
import i_sassRefs from '@assets/liz/sass_reference.png'
...
<MdxImage
  src={i_overview}
  caption='An overview of some of the pages within the Liz Design System subsite.'
/>
...
<MdxImage
  src={i_siteOrgDiagram}
  caption='A before-and-after comparison of the site organisation.'
  shadow
/>
...
<div class='grid gap-8 grid-cols-1 md:grid-cols-2'>
  <MdxImage
    shadow
    src={i_buttonV1}
    caption='The first version of Liz that was a single-page site with limited components and written for raw HTML.'
  />
  <MdxImage
    shadow
    src={i_buttonV2}
    caption='A later version with multiple pages and more details for both designs & component usage.'
  />
</div>

<MdxImage
  src={i_buttonFinal}
  caption='The latest iteration of the design system with extensive sections on content, design, and coding. It also includes both visual & code references.'
/>
...
<div class='grid gap-8 grid-cols-1 md:grid-cols-2'>
  <MdxImage
    shadow
    src={i_sassDocCode}
    caption='The SassDoc comments on mixins & variables.'
  />
  <MdxImage
    shadow
    src={i_sassDocOutput}
    caption='I parsed the SassDoc JSON object to create custom documentation visuals.'
  />
</div>
...
<MdxImage
  shadow
  src={i_componentSketches}
  caption={'Early sketches of component cataloguing and standardisation.'}
/>
