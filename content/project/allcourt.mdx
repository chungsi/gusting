...
gallery:
  - ./../assets/allcourt/competitor_comparison.jpg
  - ./../assets/allcourt/swot_matrix.jpg
  - ./../assets/allcourt/screens.jpg
  - ./../assets/allcourt/journey_map_spread.png
  - ./../assets/allcourt/journey_map_spread@0,25x.jpg
  - ./../assets/allcourt/manual_stats.png
  - ./../assets/allcourt/sketch.jpg
  - ./../assets/allcourt/match_creation.gif
  - ./../assets/allcourt/score_keeping.gif
  - ./../assets/allcourt/faults.gif
  - ./../assets/allcourt/results.gif
  - ./../assets/allcourt/stats_compare.jpg
  - ./../assets/allcourt/stats_player.jpg
...
<MdxImage gatsbyImageData={props.gallery.image2} />
...
Below are screenshots of parts of the experience of our [final prototype](#finalDesign). Take a look at the [breakdown of our final prototype](#breakdown).
...
1. **Match between system and the real world (Mental Model)**  
...
2. **Helping users recognize, diagnose and recover from errors**  
...
<MdxImage gatsbyImageData={props.gallery.image4} />
...
<MdxImage gatsbyImageData={props.gallery.image6} />

<MdxImage gatsbyImageData={props.gallery.image7} />

---

### Final Design

In our final prototype [(interact with it above)](#finalDesign), we created a functioning browser interactive prototype to reflect our desired functionality and experience. A static high-fidelity prototype only tells us half the story – added animations and complex interactions draw a better picture for how the design performs.

#### Visual design, colour choice, and readability
...
<div>
  ...
  <MdxImage imageURL={props.gallery.image8} />
...
<div>
  ...
  <MdxImage imageURL={props.gallery.image9} />

</div>

<div>

  <MdxImage imageURL={props.gallery.image10} />
...
<div>
  ...
  <MdxImage imageURL={props.gallery.image11} />
...
<div>
  ...
  <MdxImage gatsbyImageData={props.gallery.image12} />

</div>

<div>

  <MdxImage gatsbyImageData={props.gallery.image13} />
