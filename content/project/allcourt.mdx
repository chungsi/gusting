...
\# [Background and Scope](#background--scope)  
\# [Objective and Final Design](#objective--final-design)  
...
* **“Competitive” tennis players, who aren't necessarily elite or even tournament contenders.**  
...
* **Parents and coaches of competitive junior players, who tend to be very involved.**  
...
<MdxImage shadow link={props.gallery.image4} gatsbyImageData={props.gallery.image4} />
...
<div>
  ...
  <MdxImage imageURL={props.gallery.image7} />
...
<div>
  ...
  <MdxImage shadow gatsbyImageData={props.gallery.image11} />

</div>

<div>

  <MdxImage shadow gatsbyImageData={props.gallery.image12} />
