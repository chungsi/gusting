...
gallery:
  ...
  - ./../assets/liz/liz_diagramDrawing_c.jpg
...
<MdxImage
  ...
  caption={'The comment formatting within Blade components that include the variables and options to be passed to the component.'}
/>

<MdxImage
  shadow
  gatsbyImageData={props.gallery.image8}
  caption={'Documentation outputs the comments in expandable blocks, and includes any JS dependency files.'}
/>
...
<MdxImage
  ...
  caption={'The methodologies and organisation of SASS are explained on the Sass Reference page.'}
/>
